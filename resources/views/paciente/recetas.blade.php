        ...
        <header class="app-topbar justify-content-between">
            <div class="d-flex align-items-center gap-2">
                <div class="kpi-icon" style="background:#EFF6FF;width:36px;height:36px;border-radius:8px;">
                    <svg width="18" height="18" fill="none" stroke="#1d4ed8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/></svg>
                </div>
                <div>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="app-card p-4">
                    ...
                    <div class="d-flex align-items-start justify-content-between mb-3 pb-3" style="border-bottom:1px solid #f3f4f6;">
                        ...
                        <div class="text-end">
                            <div class="fw-semibold" style="font-size:0.85rem;color:#2563EB;">{{ $receta->fecha_emision->format('d M, Y') }}</div>
                    ...
                    <div class="mb-3">
                        <div class="fw-semibold small mb-2" style="color:#2563EB;">Medicamentos</div>
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-start gap-2 p-2 rounded-2" style="background:#f9fafb;border:1px solid #f3f4f6;">
                                    <div class="kpi-icon flex-shrink-0" style="background:#EFF6FF;width:28px;height:28px;border-radius:8px;">
                                        <svg width="13" height="13" fill="none" stroke="#2563EB" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/></svg>
                                    </div>
                                    <div>
                    ...
                    <div class="rounded-2 p-3" style="background:#f9fafb;border:1px solid #f3f4f6;">
                        <div class="fw-semibold small mb-1" style="color:#2563EB;">Indicaciones</div>
