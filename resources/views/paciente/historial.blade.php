        ...
        <header class="app-topbar justify-content-between">
            <div class="d-flex align-items-center gap-2">
                <div class="kpi-icon" style="background:#ccfbf1;width:36px;height:36px;border-radius:8px;">
                    <svg width="18" height="18" fill="none" stroke="#0f766e" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                </div>
                <div>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="app-card p-4">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        ...
                        <div class="text-end">
                            <div class="fw-semibold" style="font-size:0.85rem;color:#0d9488;">{{ $historial->fecha->format('d M, Y') }}</div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="rounded-2 p-3" style="background:#f9fafb;border:1px solid #f3f4f6;">
                                <div class="fw-semibold small mb-1" style="color:#0d9488;">
