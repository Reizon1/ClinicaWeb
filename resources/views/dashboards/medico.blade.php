        ...
        <main class="flex-grow-1 p-4" style="overflow-y:auto;">
            ...
            <div class="row g-3 mb-4">
                <div class="col-6 col-xl-3">
                    <div class="kpi-card">
                        <div class="kpi-icon mb-2" style="background:#ccfbf1;">
                            <svg width="18" height="18" fill="none" stroke="#0d9488" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        </div>
                ...
                <div class="col-6 col-xl-3">
                    <div class="kpi-card">
                        <div class="kpi-icon mb-2" style="background:#f0fdf4;">
                            <svg width="18" height="18" fill="none" stroke="#16a34a" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        <div class="fw-bold fs-4">{{ $citasAtendidas }}</div>
                        <div class="text-muted" style="font-size:0.75rem;">Pacientes Atendidos</div>
                    </div>
                </div>
                <div class="col-6 col-xl-3">
                    <div class="kpi-card">
                        <div class="kpi-icon mb-2" style="background:#fff7ed;">
                ...
                <div class="col-6 col-xl-3">
                    <div class="kpi-card">
                        <div class="kpi-icon mb-2" style="background:#faf5ff;">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-4 d-flex flex-column gap-3">
                    ...
                    <div class="rounded-3 p-3" style="background:#ccfbf1;border:1px solid #99f6e4;">
                        <div class="d-flex align-items-start gap-2">
                            <div class="kpi-icon flex-shrink-0" style="background:#a7f3d0;width:28px;height:28px;border-radius:8px;">
                                <svg width="13" height="13" fill="none" stroke="#0f766e" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                            </div>
                            <div>
                                <div class="fw-semibold" style="font-size:0.78rem;color:#0f766e;">Recordatorio de hoy</div>
                                <p class="mb-0" style="font-size:0.75rem;color:#0d9488;">
