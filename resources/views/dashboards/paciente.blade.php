...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-56 flex-shrink-0 flex flex-col"
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <a href="{{ route('dashboard.paciente') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-blue-100 hover:bg-white/10 text-sm transition-colors">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between flex-shrink-0">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('citas.crear') }}" class="bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-colors flex items-center gap-1.5 shadow-sm shadow-blue-100">
