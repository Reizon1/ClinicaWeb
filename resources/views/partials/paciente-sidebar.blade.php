...
<aside class="app-sidebar" style="background:linear-gradient(165deg,#1e3a8a 0%,#2563EB 55%,#0891b2 100%);">
    ...
    <div class="sidebar-brand">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <div style="font-size:0.6rem;color:rgba(147,197,253,0.8);letter-spacing:0.08em;text-transform:uppercase;">Panel Paciente</div>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-grow-1 px-2 py-3 overflow-auto">
        ...
        <div class="sidebar-nav-label mt-2">Mis Consultas</div>
        ...
        <div class="sidebar-nav-label mt-2">Servicios</div>
        ...
        <a href="{{ route('dashboard.paciente') }}#premium" class="sidebar-link" style="color:rgba(253,224,71,0.9);">
    ...
    <div class="px-2 py-3" style="border-top:1px solid rgba(255,255,255,0.1);position:relative;z-index:1;">
        <div class="d-flex align-items-center gap-2 px-2 mb-2">
            ...
            <div style="min-width:0;">
                ...
                <div style="font-size:0.6rem;color:rgba(147,197,253,0.8);letter-spacing:0.06em;text-transform:uppercase;">Paciente</div>
            </div>
        </div>
