...
<aside class="app-sidebar" style="background:linear-gradient(165deg,#1e3a8a 0%,#2563EB 55%,#0891b2 100%);">
    ...
    <div class="sidebar-brand">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <div style="font-size:0.6rem;color:rgba(147,197,253,0.8);letter-spacing:0.08em;text-transform:uppercase;">Medical Zone</div>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-grow-1 px-2 py-3 overflow-auto">
        ...
        <div class="sidebar-nav-label mt-2">Agenda</div>
        ...
        <div class="sidebar-nav-label mt-2">Configuración</div>
        ...
        <a href="{{ route('medico.perfil') }}" class="sidebar-link {{ $s==='perfil' ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            Perfil
        </a>
    ...
    <div class="px-2 py-3" style="border-top:1px solid rgba(255,255,255,0.1);position:relative;z-index:1;">
        <div class="d-flex align-items-center gap-2 px-2 mb-2">
            ...
            <div style="min-width:0;">
                <div class="text-white fw-semibold text-truncate" style="font-size:0.78rem;">Dr. {{ auth()->user()->name }}</div>
                <div style="font-size:0.6rem;color:rgba(147,197,253,0.8);letter-spacing:0.06em;text-transform:uppercase;">Médico</div>
            </div>
        </div>
